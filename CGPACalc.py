...
while True:
    try:
        ...
        input('...which is...')
        print(str(english) + str(language) + str(maths) + str(science) + str(sst) + ' CGPA!!!')
        print('I hope you liked this CGPA Calculator...')
        print('Would you like to calculate yours or your friend\'s CGPA again? Type \'Yes\' (without the quotation marks) to calculate CGPA again...')
        redo = input()
